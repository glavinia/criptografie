...
public class RC6 {
    ...
    private static int[] convertesteCuvinteBiti(byte[] key, int u, int c) {
        int[] tmp = new int[c];
    ...
    private static int[] genereazaSubChei(byte[] key) {

        int u = w / 8;
        int c = key.length / u;
        int t = 2 * r + 4;

        int[] L = convertesteCuvinteBiti(key, u, c);
    ...
    private static byte[] blocDecriptare(byte[] input) {
    ...
    private static byte[] blocCriptare(byte[] input) {
